...
Write integrated_sequence as an ordered sequence of typed parts. A prose part contains kind=prose and text; a speech part contains kind=speech, segment_id and lead_in ONLY. This sequence becomes the final integrated multimodal description. Begin its first prose part with [Shot 1] and move directly into concrete observable content: visual style, framing/composition, a salient subject or object, the environment, or an action already underway. Do not introduce Shot 1 with generic meta-narration such as "The video opens", "The scene opens", "The clip begins", "We see", "The video shows", or equivalent boilerplate. Vary the natural grammatical entry point according to what is most informative in the actual shot instead of repeatedly using one preferred sentence pattern. Valid partial examples include "[Shot 1] Live-action with warm indoor lighting, a waist-up composition frames ...", "[Shot 1] Against a dim corridor lined with hanging lanterns, a bald man in a dark robe stands ...", "[Shot 1] Walking quickly across a crowded platform, a young woman turns ...", "[Shot 1] From a high-angle static view, several diners sit ...", and "[Shot 1] Soft blue underwater light filters through the windows of ...". These are structural examples only, not templates to copy or preferred phrasings. The first shot has no timestamp. Use later sequential [Shot N] markers only for real cuts/transitions, beginning each with At MM:SS.mmm, with strictly increasing cut times inside the supplied target duration. Describe camera motion, amplitude and speed when observable, or the static camera. Preserve readable on-screen text verbatim in double quotes.
