...
MIMO25_RECORD_VERSION = "r2v.h3.mimo25_record.7"
MIMO25_SUMMARY_VERSION = "r2v.h3.mimo25_summary.7"
...
class MimoRecord(SchemaModel):
    schema_version: Literal["r2v.h3.mimo25_record.7"] = MIMO25_RECORD_VERSION
    clip_uid: str
    request_fingerprint: str = Field(pattern=r"^[0-9a-f]{64}$")
    inventory_fingerprint: str = Field(pattern=r"^[0-9a-f]{64}$")
...
class MimoSummary(SchemaModel):
    schema_version: Literal["r2v.h3.mimo25_summary.7"] = MIMO25_SUMMARY_VERSION
    inventory_scope: Literal[
        "current_diarization_asr_target_inventory",
        "canonical_visual_target_inventory",
        "explicit_case_subset",
